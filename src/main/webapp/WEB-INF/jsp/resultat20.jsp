                    ...
                    <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu" style="display: block;">
                      ...
                      <a><i class="fa fa-bolt"></i>Result
                       ...
                       <li class="current-page" ><a >Detailed View</a>
                        <li class="current-page" ><a >Global View</a>
...
<%--                         <td><%= DbServiceImpl.getRecordById(Long.parseLong(request.getParameter("db1"))).getName()%></td> --%>
             ...
             <button class="btn btn-primary" type="submit" onclick=" generateReportC();" >See Details</button>
                    </div>
