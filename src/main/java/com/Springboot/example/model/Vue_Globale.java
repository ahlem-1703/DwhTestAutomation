...
public class Vue_Globale {
	...
	public boolean equals(Object o) {
		...
		Vue_Globale that = (Vue_Globale) o;
		return Objects.equals(Code_requete, that.Code_requete) && Objects.equals(DateDeb, that.DateDeb) && Objects.equals(DateFin, that.DateFin)
				&& Objects.equals(name_kpi, that.name_kpi) && Objects.equals(val_kpi1, that.val_kpi1) && Objects.equals(val_kpi2, that.val_kpi2)
				&& Objects.equals(Gap, that.Gap) && Objects.equals(GAP_par_100, that.GAP_par_100) && Objects.equals(DataQualite, that.DataQualite)
				&& Objects.equals(acceptation, that.acceptation) && Objects.equals(NbreRecordOk, that.NbreRecordOk)
				&& Objects.equals(NbreRecordNotOk, that.NbreRecordNotOk);
	}

	@Override
	public int hashCode() {
		return Objects.hash(Code_requete, DateDeb, DateFin, name_kpi, val_kpi1, val_kpi2, Gap, GAP_par_100, DataQualite,
				acceptation, NbreRecordOk, NbreRecordNotOk);
	}
}
