                            ...
                            <form id="formkpi" class="form-horizontal form-label-left" method="post" action="${action}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input value="<%= request.getAttribute("idkpi") %>" type="number" id="id_kpi"
                                               name="id_kpi" required="required" class="form-control" hidden="true"/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <spring:bind path="requete.date">
                                            <input id="date" class="form-control" value="${requete.date}" name="date"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <spring:bind path="requete.val_kpi">
                                            <input id="valKPI" class="form-control" value="${requete.val_kpi}"
                                                   name="val_kpi" required="required" type="text"/>
                                        </spring:bind>
                                    </div>
                                    As
                                    <div class="col-md-3 col-sm-12">
                                        <spring:bind path="requete.val_kpi_alias">
                                            <input id="valKPIAs" class="form-control" value="${requete.val_kpi_alias}"
                                                   name="val_kpi_alias" required="required" type="text"/>
                                        </spring:bind>
                                    </div>
                                </div>
                                <div class="form-group row">
                              ...
                              <textarea id="copr" name="copr" required="required">
                                ...
                                <div class="field_wrapper">
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align">Dimensions <span
                                                class="required">*</span>
                                        </label>
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <input type="button" class="bouton" name="add_button" id="add_button"
                                                   value="Ajouter"/>
          ...
          <textarea cols="20" rows="30" hidden="true" class="modal-body" id="bodyModal2" name="requetee">
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                       for="dateDeb">Start Date<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 ">
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                       for="dateFin">End Date <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 ">
                                            ...
                                            <div class="modal-footer">
                                                <button class="btn btn-primary" type="button" onclick="tester();">Test
                                                </button>
