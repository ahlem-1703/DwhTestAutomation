...
// Loop through the checkboxes and check if any of them is checked
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // day
        document.getElementsByName('dailyDaysOfWeek')
        const endAtDaily = document.getElementsByName('endAtDaily');
        console.log(endAtDaily)

        scheduleName.onchange('input', handleInputChange);
        ...
        console.log(endAtWeekly)
        console.log(weeklyExecutionTime)
        // month
        const endAtMonthly = document.getElementById('endAtMonthly');
        console.log(endAtMonthly)
        const triggerType = document.getElementById('triggerType');
        console.log(triggerType.value)
        if (triggerType.value && scheduleName.value) {
